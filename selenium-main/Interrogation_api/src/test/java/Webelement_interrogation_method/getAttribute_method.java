...
public class getAttribute_method {
		...
		public static void main(String[] args) throws InterruptedException {
            ...
            System.out.println(search.getAttribute("value"));//there is no default value set so it is empty
            search.sendKeys("tool");
            search.click();
            System.out.println(search.getAttribute("value"));//it accept dynamic attribute
	}
